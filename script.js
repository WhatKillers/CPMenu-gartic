...
// @name         CPMenu[GARTIC]
// @version      1.0
// @description  Use Com Responsabilidade
// @author       CPSLK
...
let outorefresh = false;
 ...
 $('#hint').append('<div class="trbuttontr"></div>');
            ...
            if (!document.getElementById("modmenu")){
              ...
              $('#trbuttontr4').prepend('<button id="modmenu" class="closing" ><img src="https://i.imgur.com/4Dk6c7r.png" style="width:25px;height:25px;" /><span class="tooltip">CPMenu (Ctrl + M)</span></button>');
...
if (!document.querySelector(".Mobile.Mod.Menu")){
              $('.actionsMobile').prepend('<button class="Mobile CPMenu"><img src="https://i.imgur.com/JodxI35.png" style="width:25px;height:25px;" /></button>');
